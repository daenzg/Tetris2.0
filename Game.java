...
public class Game extends World
{
    ...
    public void act()
    {
        ...
        boolean shapeWillCollide = 
            ...
            (currentShape == BlockType.S || currentShape == BlockType.Z) && (rotation == 90) ||
            currentShape == BlockType.T && (rotation == 90 || rotation == 270)
            );
        
        boolean stopRotateLeft = shapeWillCollide && collideLeft || currentShape == BlockType.I && rotation == 90 && currentBlocks[0].getX() + 1 <= 2;
    ...
    {
        currentShape = BlockType.fromInt(Greenfoot.getRandomNumber(BlockType.values().length));
        dropped = false;
        rotation = 0;
